...
Outputs may be incomplete, incorrect, or unsuitable for a particular use.
Transport calculations, material mappings, nuclear data, boron distributions,
...
Synthetic demonstrations and passing software tests do not establish clinical
accuracy, safety, effectiveness, or fitness for purpose.
